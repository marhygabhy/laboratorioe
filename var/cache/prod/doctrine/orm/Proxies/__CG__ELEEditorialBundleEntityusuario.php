 ...
 */
class usuario extends \ELE\EditorialBundle\Entity\usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'id', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'nombre', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'apellido', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'correo', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'usuario', '' . "\0" . 'ELE\\EditorialBundle\\Entity\\usuario' . "\0" . 'clave'];
        }
